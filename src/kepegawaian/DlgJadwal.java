...
public class DlgJadwal extends javax.swing.JDialog {
    ...
    public DlgJadwal(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"P", "Kode Dokter", "Nama Dokter", "Hari Kerja", "Jam Mulai", "Jam Selesai", "Poliklinik", "Kuota", "Shift", "ID Jadwal"};
    ...
    private void initComponents() {
        ...
        jLabel3.setBounds(490, 10, 50, 23);
        ...
        nmdokter.setBounds(191, 12, 280, 23);
        ...
        btnDokter.setBounds(470, 10, 28, 23);
        ...
        cmbShift.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "PAGI", "SORE" }));
        ...
        cmbShift.setBounds(540, 10, 80, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (nmdokter.getText().trim().equals("")) {
            ...
            String jadwal = Sequel.cariIsi("select kd_dokter from jadwal where kd_dokter='" + kddokter.getText() + "' and hari_kerja='" + cmbHari.getSelectedItem().toString() + "' and shift='" + cmbShift.getSelectedItem() + "'");
            System.out.println("jadwal=" + jadwal);
            if (jadwal.equals("")) {
                if (Sequel.menyimpantf("jadwal",
                        "null,'" + kddokter.getText() + "','" + cmbHari.getSelectedItem() + "','"
                        ...
                        + KdPoli.getText() + "','" + Kuota.getText() + "','" + cmbShift.getSelectedItem() + "'", "Kode Dokter") == true) {
                    tampil();
                    emptTeks();
                }
            } else {
                JOptionPane.showMessageDialog(rootPane, "Jadwal Sudah ada...");
            }
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for (int i = 0; i < tbJadwal.getRowCount(); i++) {
            if (tbJadwal.getValueAt(i, 0).toString().equals("true")) {
                Sequel.queryu("delete from jadwal where id_jadwal='" + tbJadwal.getValueAt(i, 9).toString() + "'");
            }
        }
        tampil();
        emptTeks();
        ...
        if (nmdokter.getText().trim().equals("")) {
            ...
            if (tbJadwal.getSelectedRow() != -1) {
                Sequel.queryu("update jadwal set jam_mulai='" + cmbJam1.getSelectedItem() + ":" + cmbMnt1.getSelectedItem() + ":" + cmbDtk1.getSelectedItem() + "',"
                        ...
                        + "kd_poli='" + KdPoli.getText() + "',kd_dokter='" + kddokter.getText() + "',hari_kerja='" + cmbHari.getSelectedItem() + "',kuota='" + Kuota.getText()
                        + "',shift='" + cmbShift.getSelectedItem().toString() + "' where "
                        + "id_jadwal='" + tbJadwal.getValueAt(tbJadwal.getSelectedRow(), 9).toString() + "'");
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select jadwal.kd_dokter,dokter.nm_dokter,jadwal.hari_kerja, "
                    + "jadwal.jam_mulai,jadwal.jam_selesai,poliklinik.nm_poli,jadwal.kuota,jadwal.shift,jadwal.id_jadwal "
                    + "from jadwal inner join poliklinik inner join dokter "
                    + "on jadwal.kd_dokter=dokter.kd_dokter "
                    + "and jadwal.kd_poli=poliklinik.kd_poli "
